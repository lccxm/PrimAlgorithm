...
class Edge(object):
    ...
    # def __eq__(self, other):
    #     return (self.w == other.w) and (self.source_vert == other.souce_vert) and (
    #                 self.target_vert == other.target_vert)

    def __repr__(self):
        return "<weight=" + str(self.w) + ", souce_vert=" + str(self.source_vert.name) + ", target=" + str(
            self.target_vert.name) + ">"
